...
double Xi_R_CLPT(double s) {
    if (s >= 1. && s <= r_max)
        return gsl_spline_eval(spline[0], s, acc[0]);
    else if (s < 1.)
        return gsl_spline_eval(spline[0], 1., acc[0]);
    else if (s > r_max)
        return gsl_spline_eval(spline[0], r_max, acc[0]);
    else
        return 0;
}
...
double V12_CLPT(double s) {
    if (s >= 1. && s <= r_max)
        return gsl_spline_eval(spline[1], s, acc[1]);
    else if (s < 1.)
        return gsl_spline_eval(spline[1], 1., acc[1]);
    else if (s > r_max)
        return gsl_spline_eval(spline[1], r_max, acc[1]);
    else
        return 0;
}
...
double Sig_par_CLPT(double s) {
    if (s >= 1. && s <= r_max)
        return gsl_spline_eval(spline[2], s, acc[2]);
    else if (s < 1.)
        return gsl_spline_eval(spline[2], 1., acc[2]);
    else if (s > r_max)
        return gsl_spline_eval(spline[2], r_max, acc[2]);
    else
        return 0;
}
...
double Sig_per_CLPT(double s) {
    if (s >= 1. && s <= r_max)
        return gsl_spline_eval(spline[3], s, acc[3]);
    else if (s < 1.)
        return gsl_spline_eval(spline[3], 1., acc[3]);
    else if (s > r_max)
        return gsl_spline_eval(spline[3], r_max, acc[3]);
    else
        return 0;
}
